...
public class CiteIdeaDialog extends DialogFragment {
    ...
    private IdeaCiteCallback listener;

    public static CiteIdeaDialog newInstance(String contextString, Context context) {
        mContext = context;

        CiteIdeaDialog dialog = new CiteIdeaDialog();
        Bundle bundle = new Bundle();
        bundle.putString("contextString", contextString);
        dialog.setArguments(bundle);
        return dialog;
    }

    public void setListener(IdeaCiteCallback listener) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String contextString = getArguments().getString("contextString");
        contextET.setText(contextString);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.equals("") || context.equals("") || content.equals("")) {
                    ...
                    listener.dialogCiteBtnOnClick(title, context, content);
                    dismiss();
                }
            }
        });
